...
1. Kubernetes instance with the following version considerations:
    ...
    1. `clickhouse-operator` versions `0.16.0` **and after** is compatible [Kubernetes version `1.25` and after](https://kubernetes.io/releases/).
...
|---|---|---|
| Current | Kubernetes 1.25+ | https://raw.githubusercontent.com/Altinity/clickhouse-operator/master/deploy/operator/clickhouse-operator-install-bundle.yaml |
...
| `0.16.0` and greater | Kubernetes 1.25+ | https://github.com/Altinity/clickhouse-operator/raw/{OPERATOR_VERSION}/deploy/operator/clickhouse-operator-install-bundle.yaml |
