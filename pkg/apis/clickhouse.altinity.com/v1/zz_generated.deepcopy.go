...
import (
	...
	messagediffv1 "gopkg.in/d4l3k/messagediff.v1"
...
func (in *ActionPlan) DeepCopyInto(out *ActionPlan) {
	*out = *in
	if in.old != nil {
		out.old = in.old
	}
	...
	if in.specDiff != nil {
		in, out := &in.specDiff, &out.specDiff
		*out = new(messagediffv1.Diff)
		*in = *out
	}
	if in.specDiffReverse != nil {
		in, out := &in.specDiffReverse, &out.specDiffReverse
		*out = new(messagediffv1.Diff)
		*in = *out
	}
	if in.labelsDiff != nil {
		in, out := &in.labelsDiff, &out.labelsDiff
		*out = new(messagediffv1.Diff)
		*in = *out
	}
	if in.deletionTimestampDiff != nil {
		in, out := &in.deletionTimestampDiff, &out.deletionTimestampDiff
		*out = new(messagediffv1.Diff)
		*in = *out
	}
	if in.finalizersDiff != nil {
		in, out := &in.finalizersDiff, &out.finalizersDiff
		*out = new(messagediffv1.Diff)
		*in = *out
	}
	if in.attributesDiff != nil {
		in, out := &in.attributesDiff, &out.attributesDiff
		*out = new(messagediffv1.Diff)
		*in = *out
	}
	return
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ActionPlan.
func (in *ActionPlan) DeepCopy() *ActionPlan {
	if in == nil {
		return nil
	}
	out := new(ActionPlan)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *HTTPHookAction) DeepCopyInto(out *HTTPHookAction) {
	*out = *in
	if in.URL != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new HTTPHookAction.
func (in *HTTPHookAction) DeepCopy() *HTTPHookAction {
	if in == nil {
		return nil
	}
	out := new(HTTPHookAction)
	in.DeepCopyInto(out)
	return out
}
...
func (in *HookAction) DeepCopyInto(out *HookAction) {
	*out = *in
	if in.SQL != nil {
		...
		*out = new(SQLHookAction)
		(*in).DeepCopyInto(*out)
	}
	if in.Shell != nil {
		in, out := &in.Shell, &out.Shell
		*out = new(ShellHookAction)
		(*in).DeepCopyInto(*out)
	}
	if in.HTTP != nil {
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ReconcileHooks) DeepCopyInto(out *ReconcileHooks) {
	*out = *in
	if in.Pre != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ReconcileHooks.
func (in *ReconcileHooks) DeepCopy() *ReconcileHooks {
	if in == nil {
		return nil
	}
	out := new(ReconcileHooks)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SQLHookAction) DeepCopyInto(out *SQLHookAction) {
	*out = *in
	if in.Queries != nil {
		in, out := &in.Queries, &out.Queries
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SQLHookAction.
func (in *SQLHookAction) DeepCopy() *SQLHookAction {
	if in == nil {
		return nil
	}
	out := new(SQLHookAction)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ShellHookAction) DeepCopyInto(out *ShellHookAction) {
	*out = *in
	if in.Command != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ShellHookAction.
func (in *ShellHookAction) DeepCopy() *ShellHookAction {
	if in == nil {
		return nil
	}
	out := new(ShellHookAction)
